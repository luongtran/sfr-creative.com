...
/*----------------------------------------------------------*/
        ...
        if ($('.flexslider.announcements-slider').length && jQuery()) {
            var target_flexslider = $('.flexslider.announcements-slider');
            target_flexslider.flexslider({
                animation: "slide",
                controlNav: false,
                animationSpeed: 1500,
            ...
            $(".flexslider.announcements-slider").hover(function () {
                    $('.flexslider.announcements-slider .flex-direction-nav').fadeIn(200);
                },
                function () {
                    $('.flexslider.announcements-slider .flex-direction-nav').fadeOut(200);
            });
        }
        ...
        if ($('#google-map').length && jQuery()) {
            ...
            $map.gMap({
                ...
                markers: [{
                    ...
                    longitude: 46.756588,
                    icon: {
                        image: Drupal.settings.basePath + 'sites/all/themes/new_iceat/images/marker-icon.png',
                        iconsize: [45, 41],
                    },
                }],
...
/*
    $('#read_more').click(function(){
      if ( $('#read_more_content').css('visibility') == 'hidden' )
        $('#read_more_content').css('visibility','visible');
      else
        $('#read_more_content').css('visibility','hidden');

    });
*/

  $("#read_more").click(function(){
    $("#read_more_content").css('display')=='none' ? $("#read_more_content").slideDown("slow") : $("#read_more_content").slideUp("fast");
  });


  var text = $('#read_more').text();
    if (text == 'Read More...' && $("#read_more_content").css('display')!='none'){
        $('#toptitle').text('Read Less...');
    }
