...
<script type="text/javascript">
  jQuery(document).ready(function(){
    ...
    function adjustSlide(){
      ...
      options.touchEnabled=<?php print $jmnewspro_touch;?>;
    }
    adjustSlide();
    var j = jQuery.noConflict();
    var jmnewspro<?php print $module->id; ?>=j('#jmnewspro-<?php print $module->id; ?> .slider').bxSlider(options);
...
<?php endif; ?>
//        
//       jQuery('.bx-wrapper').removeAttr('style');
//       jQuery('.bx-viewport').removeAttr('style');
//       jQuery('.bx-viewport').css('width','100%');
//       jQuery('.bx-viewport').css('height','auto');
//       jQuery('.slider').removeAttr('style');
//       jQuery('.slide-item').removeAttr('style');
...
//    
//     //jQuery('.slide-item').removeAttr('style');
//     //jQuery('.slide-item').css('float','left');
//     //jQuery('.slide-item').css('position','none');
//    
//  });
